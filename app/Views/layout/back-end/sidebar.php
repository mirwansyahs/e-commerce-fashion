    ...
    <div class="main-sidebar sidebar-style-2">
        ...
        <ul class="sidebar-menu">
            ...
            <li class=""><a class="nav-link" href="diskon"><i class="fas fa-percent"></i></i> <span>Diskon</span></a></li>
            <li class="dropdown">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-shopping-bag"></i> <span>Order</span></a>
            <ul class="dropdown-menu">
                <li><a class="nav-link" href="order-semua">Semua Order</a></li>                
                <li><a class="nav-link" href="order-masuk">Order Masuk</a></li>                
                <li><a class="nav-link" href="order-selesai">Order Selesai</a></li>                
            </ul>
            </li>
            <li class=""><a class="nav-link" href="costumer"><i class="fas fa-user"></i> <span>Customer</span></a></li>
