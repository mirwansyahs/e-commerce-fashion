    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white py-4 sticky-top">
        <div class="container">
            <a class="navbar-brand d-flex justify-content-between align-items-center order-lg-0" href="index.html">
                <img src="<?= site_url('front-end/images/logo.png')?>" alt="site icon">
                <span class="text-uppercase fw-lighter ms-2">LEON ID</span>
            </a>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item px-2 py-2 border-0">
                        <a class="nav-link text-uppercase text-dark position-relative beep" href="<?= site_url('keranjang') ?>">
                            ...
                            <?php
                                ...
                                $cart = new CartModel();
                                $count = $cart->get()->getNumRows();
                            ?>
                            <span class="position-absolute start-100 translate-middle badge bg-danger"><?= $count?></span>
                        </a>
                    </li>
                    <li class="nav-item px-2 py-2 border-0">
                        <a class="nav-link text-uppercase text-dark position-relative beep" href="">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#"><i class="fa fa-user"></i> Akun Saya</a></li>
                            <li><a class="dropdown-item" href="#"><i class="fa-solid fa-location-dot"></i> Ubah Alamat</a></li>
                            <li><a class="dropdown-item" href="#"><i class="fa-solid fa-clipboard-list"></i> Pesanan Saya</a></li>
        ...
        <div class="container">
            <div class="row text-white g-4">
                <div class="col-md-6 col-lg-3">
                    <a class="text-uppercase text-decoration-none brand text-white" href="index.html">Leon ID</a>
                    <p class="text-white text-muted mt-3">Leon ID merupakan sebuah usaha toko online shop yang bergerak di bidang fashion</p>
                </div>
