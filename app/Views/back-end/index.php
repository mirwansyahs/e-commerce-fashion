            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
              <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                  ...
                  <div class="card-body">
                    Rp <?= number_format($incomePerDay['SUM(order_details.subtotal)'], 0, ',', '.') ?>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
              <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                  ...
                  <div class="card-body">
                    Rp <?= number_format($incomePerMonth['SUM(order_details.subtotal)'], 0, ',', '.') ?>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
              <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                  ...
                  <div class="card-body">
                    Rp <?= number_format($incomePerYear['SUM(order_details.subtotal)'], 0, ',', '.') ?>
                  </div>
                </div>
              </div>
            </div>
